...
# FOR INSERTING - CHECK FOR EXISTING RECIPE NAME --> ENTER RECIPE INFORMATION --> CHECK FOR EXISTING INGREDIENTS
# FOR NON-EXISTING INGREDIENTS, ADD TO INGREDIENTS --> POPULATE JUNCTION R_IG W/ QUANTITY/UNIT AND SEARCH R_ID AND IG_ID